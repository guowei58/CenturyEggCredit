...
export function CompanySuppliersTab({
  ...
  const prompt = safeTicker ? fillCompanyPromptTemplate(suppliersTemplate, safeTicker, companyName) : "";
...
<TabPromptOpenInAiButtons
  ...
  setStatusMessage={setStatusMessage}
            ...
            persistAfterResult={async (text) => {
              ...
              if (!safeTicker) return;
              const ok = await saveToServer(safeTicker, "suppliers", trimmed);
