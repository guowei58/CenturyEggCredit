...
export function CompanyPresentationsTab({
  ...
  const prompt = useMemo(() => {
    ...
    return fillCompanyPromptTemplate(presentationsTemplate, safeTicker, companyName);
  }, [safeTicker, companyName, presentationsTemplate]);
...
<TabPromptOpenInAiButtons
  ...
  setStatusMessage={setStatusMessage}
            ...
            persistAfterResult={async (text) => {
              ...
              if (!safeTicker) return;
              const ok = await saveToServer(safeTicker, "presentations", trimmed);
