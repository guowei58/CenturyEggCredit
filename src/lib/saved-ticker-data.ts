...
export const SAVED_DATA_FILES: Record<string, string> = {
  ...
  "industry-publications": "industry-publications.txt",
  "industry-value-chain": "industry-value-chain.txt",
  ...
  "lme-analysis": "lme-analysis.md",
  "lme-analysis-meta": "lme-analysis-meta.json",
  ...
  "ai-credit-memo-kafka": "ai-credit-memo-kafka.md",
  "ai-credit-memo-kafka-meta": "ai-credit-memo-kafka-meta.json",
  "ai-credit-memo-kafka-source-pack": "ai-credit-memo-kafka-source-pack.txt",
  "ai-credit-memo-nietzsche": "ai-credit-memo-nietzsche.md",
  "ai-credit-memo-nietzsche-meta": "ai-credit-memo-nietzsche-meta.json",
  "ai-credit-memo-nietzsche-source-pack": "ai-credit-memo-nietzsche-source-pack.txt",
...
export const SAVED_TAB_FILENAME_AI_PRIORITY: readonly string[] = [
  ...
  "ai-credit-memo-kafka.md",
  "ai-credit-memo-kafka-meta.json",
  "ai-credit-memo-nietzsche.md",
  "ai-credit-memo-nietzsche-meta.json",
  "business-model.txt",
  "how-stuff-works.txt",
  "company-history.txt",
  "capital-allocation.txt",
  "credit-timeline.txt",
  "capital-structure.txt",
  "subsidiary-list.txt",
  "porters-five-forces.txt",
  "industry-history-drivers.txt",
  "industry-value-chain.txt",
  "competitors.txt",
  "startup-risks.txt",
  "risk-from-10k.txt",
