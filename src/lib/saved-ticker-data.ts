...
export const SAVED_DATA_FILES = {
  ...
  "competitor-earnings-readthrus": "competitor-earnings-readthrus.txt",
  "competitor-earnings-readthrus-inputs": "competitor-earnings-readthrus-inputs.json",
...
export const SAVED_TAB_FILENAME_AI_PRIORITY: readonly string[] = [
  ...
  "competitors.txt",
  "competitor-earnings-readthrus.txt",
  "startup-risks.txt",
  "ai-risk.txt",
  "risk-from-10k.txt",
